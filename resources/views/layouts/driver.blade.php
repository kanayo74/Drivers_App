@php use App\Models\Trip; @endphp
@props(['pending' => Trip::where('driver_id',auth()->id())->where('status','approved')->count()])
	...
	<main class="main">
		<div class="topbar">
			<div class="topbar-left">
				<div>
					<div class="page-title">@yield('page-title','Driver Dashboard')</div>
